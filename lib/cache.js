...
// Upper bound (100 years). Keeps the interpolated SQLite date modifier inside
// the range SQLite can actually compute, and rejects values that overflow to
// exponential notation or Infinity before they reach a prepared statement.
